 ...
 */
static __inline__ unsigned long millis( void ) __attribute__((always_inline));
 ...
 */
static __inline__ unsigned long micros( void ) __attribute__((always_inline));
static __inline__ unsigned long micros(void)
{
  return clock();
}
 ...
 */
static __inline__ void delay( unsigned long dwMs ) __attribute__((always_inline));
static __inline__ void delay(unsigned long dwMs)
{
  msleep(dwMs);
}
